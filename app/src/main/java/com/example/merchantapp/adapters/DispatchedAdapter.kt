...
class DispatchedAdapter(
    var list:ArrayList<Order>,var riders:List<DeliveryBoy>, val adapterInterface: AdapterInterface, val context:Context
) :
        RecyclerView.Adapter<DispatchedAdapter.ViewHolder>(){
